...
class MonthAmountChart extends StatelessWidget {
        ...
        titlesData: FlTitlesData(
          leftTitles: AxisTitles(
            sideTitles: SideTitles(
              reservedSize: 60,
              showTitles: true,
              getTitlesWidget: (value, _) => Text(value.moneyFormatted, style: theme.textTheme.bodySmall,),
              maxIncluded: false
            )
          ),
  ...
  BarChartGroupData _toBar(int ind, NamedAmount tracker, double maxY, ThemeData theme) {
