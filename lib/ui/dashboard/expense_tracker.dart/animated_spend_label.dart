...
class AnimatedSpendLabel extends StatefulWidget {
  ...
  AnimatedSpendLabel({
    super.key,
    AnimatedSpendLabelController? controller,
  }) : _controller = controller ?? AnimatedSpendLabelController();
  
  @override
  State<StatefulWidget> createState() =>
    _AnimatedSpendLabelState();

}

class _AnimatedSpendLabelState extends State<AnimatedSpendLabel> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    final animation = IntTween(begin: _prevValue, end: _currentValue)
