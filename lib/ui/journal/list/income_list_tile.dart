...
class IncomeListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final avatarTextColor = income.isPending? context.colorScheme.error : theme.colorScheme.onPrimaryContainer;
    final titleColor = income.isPending? context.colorScheme.error : theme.colorScheme.onSurface;
    final mainAmountColor = income.isPending? context.colorScheme.error : theme.colorScheme.onSurface.withAlpha(200);
    final centsAmountColor = income.isPending? context.colorScheme.error : theme.colorScheme.onSurfaceVariant;
      ...
      trailing: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(main, style: theme.textTheme.headlineSmall?.copyWith(color: mainAmountColor)),
