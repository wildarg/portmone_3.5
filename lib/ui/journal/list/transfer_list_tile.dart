...
class TransferListTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final avatarIconColor = transfer.isPending
        ? context.colorScheme.error
        : theme.colorScheme.onSecondaryContainer;
    final mainAmountColor = transfer.isPending
        ? context.colorScheme.error
        : theme.colorScheme.onSurface.withAlpha(200);
    final centsAmountColor = transfer.isPending
        ? context.colorScheme.error
        : theme.colorScheme.onSurfaceVariant;
    final transferIconColor = transfer.isPending
        ? context.colorScheme.error
    ...
    return Dismissible(
      ...
      child: ListTile(
        ...
        subtitle: transfer.notes.isNotEmpty
            ? TransactionNotes(transfer.notes)
            : null,
        onTap: onTap,
      ),
    );
