...
class TransactionNotes extends StatelessWidget {
  ...
  TransactionNotes(this.text, {super.key, this.onTagTap})
  ...
  Widget build(BuildContext context) {
    return parts.isEmpty
        ...
        : RichText(
            ...
            text: TextSpan(children: <InlineSpan>[..._getSpans(context)]),
          );
  }
  ...
  InlineSpan _getSpan(String text, BuildContext context) => text.startsWith("#")
      ? WidgetSpan(
          child: InkWell(
            onTap: () {
              if (onTagTap != null) {
                ...
                context.dispatch(SetTextFilterAction(text));
              }
            },
            child: Text(
              text,
