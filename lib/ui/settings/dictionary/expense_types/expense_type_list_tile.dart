...
import 'package:portmone_bloc/ui/settings/dictionary/expense_types/expense_type_dialog.dart';
...
class ExpenseTypeListTile extends StatelessWidget {

  final TransactionType transactionType;
  final VoidCallback? onTap;

  const ExpenseTypeListTile({
    super.key, 
    ...
    return ListTile(
      ...
      trailing: Column(
        ...
        children: [
          UiButton.flatRounded(
            ...
            onTap: () => context.dispatch(UpdateExpenseTypeAction(transactionType.copyWith(isArchived: !transactionType.isArchived))),
          ),
          Text(label)
        ],
      ),
      onTap: () {
        showDialog(
          context: context,
          builder: (context) {
            return RenameExpenseTypeDialog(transactionType: transactionType);
          },
        );
      },
    );
