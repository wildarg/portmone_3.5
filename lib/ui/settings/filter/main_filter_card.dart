        ...
        builder:(context, state) => Column(
          ...
          children: [
            UiDateField(
              ...
              onChange: (value) => 
                context.dispatch(UpdateMainFilterAction(filter: state.copyWith(startDate: Nullable(value)))),              
            ),
            UiDateField(
              label: 'End date',
              ...
              onChange: (value) => 
                context.dispatch(UpdateMainFilterAction(filter: state.copyWith(endDate: Nullable(value)))),
            ),
            UiSwitcher(
              ...
              onChanged: (value) => 
                context.dispatch(UpdateMainFilterAction(filter: state.copyWith(plannedInclude: value))),
            )
          ],
        ),
      )
