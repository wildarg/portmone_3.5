  ...
  AmountTypeInfo _toExpenseTypeInfo(Map<String, Object?> map, List<String> monthNames) {
    return AmountTypeInfo(
      ...
      chartData: [
        ...
        NamedAmount(map.getMoney('spent_prev_3_months'), monthNames[1]),
        NamedAmount(map.getMoney('spent_prev_2_months'), monthNames[2]),
        NamedAmount(map.getMoney('spent_prev_month'), monthNames[3]),
        NamedAmount(map.getMoney('spent_current_month'), monthNames[4]),
      ],
    );
  }
