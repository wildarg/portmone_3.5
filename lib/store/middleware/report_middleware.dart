...
Middleware reportsMiddleware(ReportsRepo repo) =>
...
void _refreshAccountsBalance(
  ...
  Future(() async {
    ...
    store.dispatch(
      SetAccountBalanceReportAction(data: accountBalance.toList()),
    );
  });
}

void _refreshTotalExpense(
  PortmoneStore store,
  ReportsRepo repo,
  MainFilter filter,
) {
